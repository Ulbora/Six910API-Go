...
func TestSix910API_GetProductManufacturerListByProductSearch(t *testing.T) {
	var sapi Six910API
	//sapi.SetAPIKey("123")
	sapi.storeID = 59
	...
	res := api.GetProductManufacturerListByProductSearch("ammo", &head)
	fmt.Println("GetProductsByProductSearch in get: ", *res)
